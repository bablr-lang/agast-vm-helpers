...
import { freezeRecord, isRecord, isString } from '@bablr/agast-helpers/object';
import { buildTag } from '@bablr/agast-helpers/builders';

const isObject = (val) => val !== null && typeof val === 'object';

export const buildOptions = (options) => {
  let { literal, shift, bind, allowEmpty, escape, internal, hold } = options;
...
export const buildEmbeddedInstruction = (instr) => {
  if (!isRecord(instr)) throw new Error();
